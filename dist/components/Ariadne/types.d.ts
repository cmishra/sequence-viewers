import { z } from 'zod';
import { GapSchema, SpaceSchema, StopSchema, UnknownSchema, aaSchema, angleSchema, annotatedBaseSchema, annotatedSequenceSchema, annotationSchema, annotationTypeSchema, ariadneSelectionSchema, coorSchema, nuclSchema, stackedAnnotationSchema } from './schemas';
